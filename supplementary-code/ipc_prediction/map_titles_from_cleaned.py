...
ENRICHED_PATH: Path = DATA_DIR / "ipc_enriched_v1.json"
CLEANED_PATH: Path = DATA_DIR / "ipc_cleaned_v4.json"
OUTPUT_PATH: Path = DATA_DIR / "ipc_enriched_v1_final.json"
MISSING_LOG_PATH: Path = DATA_DIR / "missing_title_mapping.log"
...
def main() -> None:
    ...
    try:
        ...
        logger.error("Failed to write missing log: %s", exc)
        raise
